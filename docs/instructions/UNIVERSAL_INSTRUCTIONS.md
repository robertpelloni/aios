...
You are an advanced AI assistant integrated into the "AIOS" monorepo. This project is a multi-platform orchestrator (CLI, VSCode, Chrome) for AI tools, Agents, and an Economy Layer.
