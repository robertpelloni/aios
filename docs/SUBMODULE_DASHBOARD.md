...
**Last Updated:** 2025-12-28 11:30:17
...
|------|------|---------|--------|
| **CLIProxyAPI** | `submodules/CLIProxyAPI` | v6.6.63 | `4579248` |
...
| **metamcp** | `submodules/metamcp` | v2.4.21-68-gf195a71 | `f195a71` |
...
| **BMAD-METHOD** | `references/agents/BMAD-METHOD` | 6.0.0-alpha.21-6-gea421adb | `ea421ad` |
| **OpenHands** | `references/agents/OpenHands` | 0.22.0-2476-gf8e4b5562 | `f8e4b55` |
| **agent-zero** | `references/agents/agent-zero` | v0.9.7-11-g1916958 | `1916958` |
| **amplifier** | `references/agents/amplifier` | heads/main | `de4f553` |
...
| **openagents** | `references/agents/openagents` | v0.8.0-54-gd205bc03 | `d205bc0` |
...
| **beads** | `references/memory/beads` | v0.39.1-2-gb1859f54 | `b1859f5` |
